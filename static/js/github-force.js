...
!(function(){
    ...
    var margin;
    var svg = d3.select("#github-force").append("svg");
    var chartLayer = svg.append("g").classed("chartLayer", true);

    // drawLinkedForcer()

    function drawLinkedForcer() {
        var range = 100;
        var data = {
    ...
    function setSize(data) {
        width = document.querySelector("#github-force").clientWidth;
        height = document.querySelector("#github-force").clientHeight;
