...
//     var data = JSON.parse(localStorage.getItem("repos"));
//     data = _.filter(data, function (o) { return !o.fork && typeof(o.language) !== "undefined"; });
//     console.log(data);
//     callback(data);
// }
...
//     // console.log(data, body, stat);

//     var $repos = $("#github-repos").children().first();
//     // $("#github-repos").text(data);

//     for (var i = 0; i < data.length; i++) {

//         var $col = $("<div class='col-sm-12 col-md-6 col-lg-4 my-1'></div>");
//         $repos.append($col);

//         var repo = data[i];
//         // var $card = $(cardTemplate);

//         var forkOGram = repo.fork?"<span class='text-info'>fork</span> ":"<span class='text-success'>source</span> ";
...
//             <h4 class="card-title">
//             <img src="` + repo.owner.avatar_url + `" class="img-fluid rounded" style="max-height: 1.2em;" />
//             <a href="` + repo.html_url + `" target="_blank" style="color: black;" >` + repo.name + `</a></h4>
//             <p class="card-text"><small>` + repo.description + `</small></p>
//             </div>
            
//             <div class="card-footer text-muted" style="font-size: 0.7em;">
//             <strong style="color: ` + github_language_colors[repo["language"]]['color'] + `;">` + repo["language"] + `</strong>&nbsp;&nbsp;&nbsp;
//             ` + forkOGram + `&nbsp;&nbsp;&nbsp;
//             <i class="octicon octicon-telescope"></i>` + repo.stargazers_count + `&nbsp;&nbsp;&nbsp;
//             <i class="octicon octicon-git-branch"></i>` + repo.forks_count  + `
//             </div>
//             </div>`;
//         var $card = $(cardHTML);
//         $repos.children().last().append($card);
//     }
